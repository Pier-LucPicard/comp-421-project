...
?>
<html>
<!-- This page is the profile of a user. It displays his info and his walls -->
<head>
    <script src="jquery-3.2.0.min.js"></script>
    <script>
        var numWalls = 0;//The number of walls the user has

        // Load user info and walls
        ...
        //Send a query to create a new wall
        ...
        $(document).on("click", ".wall_delete", function deleteWall() {
            ...
            var data = {
                type: "delete_wall",
                wall_id: $(this).closest(".wall_cell").data("wall_id")
            };
            $.ajax({
                method: "POST",
                url: "queries.php",
...
<div class="mdl-layout mdl-js-layout mdl-layout--fixed-header">
    ...
    <div id="wall_cell_template" class="wall_cell mdl-list__item" style="display: none">
        ...
        <a class="wall_delete mdl-list__item-secondary-action" href="#"><i
                class="material-icons mdl-list__item-secondary-action">delete</i></a>
            ...
            <div class="mdl-list__item " style="display:table">
                <form id="form_add_wall" style="display: none">
                    ...
                    <div class="mdl-textfield mdl-js-textfield ">
                        <textarea class="mdl-textfield__input" name="descr" maxlength="500" required
                                  rows="2"></textarea>
