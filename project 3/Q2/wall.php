...
?>
<html>
<!-- This is the page for walls. It display the wall info and posts, comments and reactions on the wall -->
<head>
...
<script>
    //Load the wall, posts, comments and reactions
    ...
    //Submit a query to create a new post
    ...
    //Submit a query to comment on a post
    ...
    //Given post data, inserts a new post in the html
    function insertPost(post) {
        ...
        cell.find(".check_like").prop("checked", post.my_reaction == "like");
        cell.find(".check_happy").prop("checked", post.my_reaction == "happy");
        cell.find(".check_sad").prop("checked", post.my_reaction == "sad");
        cell.find(".check_angry").prop("checked", post.my_reaction == "angry");
        cell.find(".check_excited").prop("checked", post.my_reaction == "excited");
    ...
    //Update the reaction count of a post or comment component
    ...
    //Given comment data, insert a comment in the html
    function insertComment(comment, cell) {
        ...
        commentCell.find(".check_like").prop("checked", comment.my_reaction == "like");
        commentCell.find(".check_happy").prop("checked", comment.my_reaction == "happy");
        commentCell.find(".check_sad").prop("checked", comment.my_reaction == "sad");
        commentCell.find(".check_angry").prop("checked", comment.my_reaction == "angry");
        commentCell.find(".check_excited").prop("checked", comment.my_reaction == "excited");
    ...
    //Submit a post reaction query when the reaction checkboxes are changed
    ...
    //Submit a comment reaction query when comment checkboxes are changed
    ...
    //Submit a query to delete a comment
    ...
    //Submit a query to delete a post
                    ...
                    <div class="mdl-grid">
                        <div class="mdl-cell mdl-cell--9-col">
                            <div class="mdl-textfield mdl-js-textfield " style="width:inherit">
                                <textarea id="new-comment" name="text" class="mdl-textfield__input" maxlength="2000"
                                          required></textarea>
                        ...
                        <div class="mdl-cell mdl-cell--3-col">
                            <div class="mdl-textfield mdl-js-textfield mdl-textfield--expandable">
                                ...
                                <div class="mdl-textfield__expandable-holder">
                                    <input class="mdl-textfield__input" name="url" maxlength="2000" type="text"
                                           id="sample6">
    ...
    <div class=" mdl-card mdl-shadow--2dp " style="width:inherit">
        ...
        <div class="mdl-card__actions mdl-card--border">
            ...
            <div class="mdl-card__menu">
                <button id="del_post"
                        class="mdl-button mdl-button--icon mdl-js-button mdl-js-ripple-effect delete_post">
                ...
                <div align="center">
                    <form class="form_comment mdl-grid">
                        ...
                        <div class="mdl-textfield mdl-js-textfield mdl-cell mdl-cell--10-col">
                            <input class="mdl-textfield__input" type="text" name="text" placeholder="My comment"
                                   maxlength="500" required>

                        </div>
                        <div class="mdl-cell mdl-cell--2-col">
                            <input type="submit"
                                   class="button_comment mdl-button mdl-js-button  mdl-button--raised mdl-button--colored"
                                   style="display:flex" value="Comment">
                        </div>
                    </form>

                    <div class="header_comments " style="display: inline-block"></div>
                    &nbsp;
                    <button class="post_show mdl-button mdl-button--colored mdl-js-button mdl-js-ripple-effect">Show
                    </button>
                    <div class="mdl-grid">
            ...
            <div id="comment_template" class="comment_cell mdl-list__item mdl-cell mdl-cell--12-col"
                 style="display: none">
                ...
                <div class=" mdl-card mdl-shadow--2dp mdl-cell--12-col ">
                    ...
                    <div class="div_comment_reaction">
                        ...
                        <input type="checkbox" name="sad" class="check_sad"><span class="num_sad">0 Sad</span>
                        <input type="checkbox" name="angry" class="check_angry"><span class="num_angry">0 Angry</span>
                        <input type="checkbox" name="excited" class="check_excited"><span
                            class="num_excited">0 Excited</span>
                    </div>

                    <div class="mdl-card__menu">
                        <button class="delete_comment mdl-button mdl-button--icon mdl-js-button mdl-js-ripple-effect"><i
