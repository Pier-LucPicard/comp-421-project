...
<div align="center" class="mdl-layout__content">
    <br>
    <div class="mdl-layout-title">Find Users<hr></div>
    <form id="form_search">
    ...
    <button class="button_offset mdl-button mdl-js-button mdl-button--accent" data-offset="-10"><i class="material-icons">arrow_back</i>Previous results </button>
    <button class="button_offset mdl-button mdl-js-button mdl-button--accent" data-offset="10">Next results <i class="material-icons">arrow_forward</i></button>
    <br>
</div>
<div id="user_template" class="user_cell mdl-grid" style="display: none">
    ...
    <div class="mdl-cell mdl-list__item mdl-cell--1-col"></div>
        ...
        <button class="button_visit mdl-button mdl-js-button mdl-button--raised mdl-button--colored mdl-cell  mdl-cell--3-col">Visit User Profile</button>
</div>
