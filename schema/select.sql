...
where Users.city = 'Bafoussam') and Users.city='Bafoussam';
...
and Users.city in (SELECT city from Users group by city having count(email)>2);
...
from Post, wall where Post.wall_id = Wall.wall_id; 
